...
/**
 * Getting all the recipe data from the recipesJson array.
 * @return {Promise}
 */
 ...
 * @return {String} recipe's image URL if exists, else null
 **/
 ...
 * @param {Object} data: JSON Object
 * @return {String} recipe's title if exists, else null
 **/
 ...
 * @param {Object} data: JSON Object
 * @return {String} recipe's total time to cook/prep
 **/
